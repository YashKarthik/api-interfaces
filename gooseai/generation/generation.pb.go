...
func (x *TransformType) GetSequence() *TransformSequence {
	if x, ok := x.GetType().(*TransformType_Sequence); ok {
		return x.Sequence
	}
	return nil
}
...
type TransformType_Sequence struct {
	Sequence *TransformSequence `protobuf:"bytes,3,opt,name=sequence,proto3,oneof"`
}
...
func (*TransformType_Sequence) isTransformType_Type() {}
...
type TransformAddNoise struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Amount float32 `protobuf:"fixed32,1,opt,name=amount,proto3" json:"amount,omitempty"`  // amount of gaussian noise to add
	Seed   *uint32 `protobuf:"varint,2,opt,name=seed,proto3,oneof" json:"seed,omitempty"` // random seed for the noise generation
}

func (x *TransformAddNoise) Reset() {
	*x = TransformAddNoise{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformAddNoise) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformAddNoise) ProtoMessage() {}

func (x *TransformAddNoise) ProtoReflect() protoreflect.Message {
	mi := &file_generation_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformAddNoise.ProtoReflect.Descriptor instead.
func (*TransformAddNoise) Descriptor() ([]byte, []int) {
	return file_generation_proto_rawDescGZIP(), []int{20}
}

func (x *TransformAddNoise) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *TransformAddNoise) GetSeed() uint32 {
	if x != nil && x.Seed != nil {
		return *x.Seed
	}
	return 0
...
type TransformBlend struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Amount float32   `protobuf:"fixed32,1,opt,name=amount,proto3" json:"amount,omitempty"` // blend amount from 0 to 1
	Target *Artifact `protobuf:"bytes,2,opt,name=target,proto3" json:"target,omitempty"`   // target image
}

func (x *TransformBlend) Reset() {
	*x = TransformBlend{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformBlend) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformBlend) ProtoMessage() {}

func (x *TransformBlend) ProtoReflect() protoreflect.Message {
	mi := &file_generation_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformBlend.ProtoReflect.Descriptor instead.
func (*TransformBlend) Descriptor() ([]byte, []int) {
	return file_generation_proto_rawDescGZIP(), []int{21}
}

func (x *TransformBlend) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *TransformBlend) GetTarget() *Artifact {
	if x != nil {
		return x.Target
	}
	return nil
...
type TransformColorMatch struct {
	...
	ColorMode ColorMatchMode `protobuf:"varint,1,opt,name=color_mode,json=colorMode,proto3,enum=gooseai.ColorMatchMode" json:"color_mode,omitempty"` // color mode to use
	Image     *Artifact      `protobuf:"bytes,2,opt,name=image,proto3" json:"image,omitempty"`                                                       // image to match
}
...
func (x *TransformColorMatch) GetImage() *Artifact {
	if x != nil {
		return x.Image
	}
	return nil
...
type TransformContrast struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Brightness *float32 `protobuf:"fixed32,1,opt,name=brightness,proto3,oneof" json:"brightness,omitempty"` // scale on pixel intensities, 1.0 is no change
...
func (x *TransformContrast) Reset() {
	*x = TransformContrast{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformContrast) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformContrast) ProtoMessage() {}

func (x *TransformContrast) ProtoReflect() protoreflect.Message {
	mi := &file_generation_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformContrast.ProtoReflect.Descriptor instead.
func (*TransformContrast) Descriptor() ([]byte, []int) {
	return file_generation_proto_rawDescGZIP(), []int{23}
}

func (x *TransformContrast) GetBrightness() float32 {
...
func (x *TransformContrast) GetContrast() float32 {
...
type TransformDepthCalc struct {
	...
	Export      *bool    `protobuf:"varint,1,opt,name=export,proto3,oneof" json:"export,omitempty"`                               // return the depth map as an artifact
	BlendWeight *float32 `protobuf:"fixed32,2,opt,name=blend_weight,json=blendWeight,proto3,oneof" json:"blend_weight,omitempty"` // blend factor between AdaBins (0.0) and MiDaS (1.0)
}
...
func (x *TransformDepthCalc) GetExport() bool {
...
type TransformMatrix struct {
	...
	// [c, d, ty] . [y]
	// [0, 0, 1 ]   [1]
	Data []float32 `protobuf:"fixed32,1,rep,packed,name=data,proto3" json:"data,omitempty"` // 3x3 affine or perspective matrix for 2D
}
...
type TransformWarp2D struct {
	...
	TranslateX float32          `protobuf:"fixed32,4,opt,name=translate_x,json=translateX,proto3" json:"translate_x,omitempty"`                        // horizontal translation in pixels
	TranslateY float32          `protobuf:"fixed32,5,opt,name=translate_y,json=translateY,proto3" json:"translate_y,omitempty"`                        // vertical translation in pixels
	Rotate     float32          `protobuf:"fixed32,2,opt,name=rotate,proto3" json:"rotate,omitempty"`                                                  // rotation in degrees
	Scale      float32          `protobuf:"fixed32,3,opt,name=scale,proto3" json:"scale,omitempty"`                                                    // scale factor (>1 zooms in, <1 zooms out)
	Matrix     *TransformMatrix `protobuf:"bytes,6,opt,name=matrix,proto3,oneof" json:"matrix,omitempty"`                                              // 3x3 matrix
}
...
func (x *TransformWarp2D) GetMatrix() *TransformMatrix {
	if x != nil {
		return x.Matrix
	}
	return nil
...
type TransformWarp3D struct {
	...
	BorderMode BorderMode `protobuf:"varint,1,opt,name=border_mode,json=borderMode,proto3,enum=gooseai.BorderMode" json:"border_mode,omitempty"` // extrapolation of border pixels
	TranslateX float32    `protobuf:"fixed32,3,opt,name=translate_x,json=translateX,proto3" json:"translate_x,omitempty"`                        // horizontal translation
	TranslateY float32    `protobuf:"fixed32,4,opt,name=translate_y,json=translateY,proto3" json:"translate_y,omitempty"`                        // vertical translation
	TranslateZ float32    `protobuf:"fixed32,5,opt,name=translate_z,json=translateZ,proto3" json:"translate_z,omitempty"`                        // forward translation
	RotateX    float32    `protobuf:"fixed32,6,opt,name=rotate_x,json=rotateX,proto3" json:"rotate_x,omitempty"`                                 // rotation around X-axis in degrees (pitch)
	RotateY    float32    `protobuf:"fixed32,7,opt,name=rotate_y,json=rotateY,proto3" json:"rotate_y,omitempty"`                                 // rotation around Y-axis in degrees (yaw)
	RotateZ    float32    `protobuf:"fixed32,8,opt,name=rotate_z,json=rotateZ,proto3" json:"rotate_z,omitempty"`                                 // rotation around Z-axis in degrees (roll)
	NearPlane  float32    `protobuf:"fixed32,9,opt,name=near_plane,json=nearPlane,proto3" json:"near_plane,omitempty"`                           // near clipping plane of view frustum
	FarPlane   float32    `protobuf:"fixed32,10,opt,name=far_plane,json=farPlane,proto3" json:"far_plane,omitempty"`                             // far clipping plane of view frustum
	Fov        float32    `protobuf:"fixed32,11,opt,name=fov,proto3" json:"fov,omitempty"`                                                       // field of view in degrees
}
...
type TransformWarpFlow struct {
	...
	FlowMap   *Artifact `protobuf:"bytes,1,opt,name=flow_map,json=flowMap,proto3,oneof" json:"flow_map,omitempty"`       // precomputed flow asset
	PrevFrame *Artifact `protobuf:"bytes,2,opt,name=prev_frame,json=prevFrame,proto3,oneof" json:"prev_frame,omitempty"` // pair of frames to compute flow from
	NextFrame *Artifact `protobuf:"bytes,3,opt,name=next_frame,json=nextFrame,proto3,oneof" json:"next_frame,omitempty"`
}
...
func (x *TransformWarpFlow) GetFlowMap() *Artifact {
	if x != nil {
		return x.FlowMap
	}
	return nil
...
func (x *TransformWarpFlow) GetPrevFrame() *Artifact {
	if x != nil {
		return x.PrevFrame
	}
	return nil
...
func (x *TransformWarpFlow) GetNextFrame() *Artifact {
	if x != nil {
		return x.NextFrame
	}
	return nil
...
type TransformOperation struct {
	...
	//	*TransformOperation_AddNoise
	//	*TransformOperation_Blend
	//	*TransformOperation_ColorMatch
	//	*TransformOperation_Contrast
	//	*TransformOperation_DepthCalc
	//	*TransformOperation_Warp2D
	//	*TransformOperation_Warp3D
	//	*TransformOperation_WarpFlow
	Xform isTransformOperation_Xform `protobuf_oneof:"xform"`
}
...
func (m *TransformOperation) GetXform() isTransformOperation_Xform {
	if m != nil {
		return m.Xform
	}
	return nil
...
func (x *TransformOperation) GetAddNoise() *TransformAddNoise {
	if x, ok := x.GetXform().(*TransformOperation_AddNoise); ok {
		return x.AddNoise
	}
	return nil
}

func (x *TransformOperation) GetBlend() *TransformBlend {
	if x, ok := x.GetXform().(*TransformOperation_Blend); ok {
		return x.Blend
	}
	return nil
}

func (x *TransformOperation) GetColorMatch() *TransformColorMatch {
	if x, ok := x.GetXform().(*TransformOperation_ColorMatch); ok {
		return x.ColorMatch
	}
	return nil
}

func (x *TransformOperation) GetContrast() *TransformContrast {
	if x, ok := x.GetXform().(*TransformOperation_Contrast); ok {
		return x.Contrast
	}
	return nil
}

func (x *TransformOperation) GetDepthCalc() *TransformDepthCalc {
	if x, ok := x.GetXform().(*TransformOperation_DepthCalc); ok {
		return x.DepthCalc
	}
	return nil
}

func (x *TransformOperation) GetWarp2D() *TransformWarp2D {
	if x, ok := x.GetXform().(*TransformOperation_Warp2D); ok {
		return x.Warp2D
	}
	return nil
}

func (x *TransformOperation) GetWarp3D() *TransformWarp3D {
	if x, ok := x.GetXform().(*TransformOperation_Warp3D); ok {
		return x.Warp3D
	}
	return nil
}

func (x *TransformOperation) GetWarpFlow() *TransformWarpFlow {
	if x, ok := x.GetXform().(*TransformOperation_WarpFlow); ok {
		return x.WarpFlow
	}
	return nil
}

type isTransformOperation_Xform interface {
	isTransformOperation_Xform()
}

type TransformOperation_AddNoise struct {
	AddNoise *TransformAddNoise `protobuf:"bytes,1,opt,name=add_noise,json=addNoise,proto3,oneof"`
}

type TransformOperation_Blend struct {
	Blend *TransformBlend `protobuf:"bytes,6,opt,name=blend,proto3,oneof"`
}

type TransformOperation_ColorMatch struct {
	ColorMatch *TransformColorMatch `protobuf:"bytes,2,opt,name=color_match,json=colorMatch,proto3,oneof"`
}

type TransformOperation_Contrast struct {
	Contrast *TransformContrast `protobuf:"bytes,8,opt,name=contrast,proto3,oneof"`
}

type TransformOperation_DepthCalc struct {
	DepthCalc *TransformDepthCalc `protobuf:"bytes,7,opt,name=depth_calc,json=depthCalc,proto3,oneof"`
}

type TransformOperation_Warp2D struct {
	Warp2D *TransformWarp2D `protobuf:"bytes,3,opt,name=warp2d,proto3,oneof"`
}

type TransformOperation_Warp3D struct {
	Warp3D *TransformWarp3D `protobuf:"bytes,4,opt,name=warp3d,proto3,oneof"`
}

type TransformOperation_WarpFlow struct {
	WarpFlow *TransformWarpFlow `protobuf:"bytes,5,opt,name=warp_flow,json=warpFlow,proto3,oneof"`
}

func (*TransformOperation_AddNoise) isTransformOperation_Xform() {}

func (*TransformOperation_Blend) isTransformOperation_Xform() {}

func (*TransformOperation_ColorMatch) isTransformOperation_Xform() {}

func (*TransformOperation_Contrast) isTransformOperation_Xform() {}

func (*TransformOperation_DepthCalc) isTransformOperation_Xform() {}

func (*TransformOperation_Warp2D) isTransformOperation_Xform() {}

func (*TransformOperation_Warp3D) isTransformOperation_Xform() {}

func (*TransformOperation_WarpFlow) isTransformOperation_Xform() {}

type TransformSequence struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Operations []*TransformOperation `protobuf:"bytes,1,rep,name=operations,proto3" json:"operations,omitempty"`
}

func (x *TransformSequence) Reset() {
	*x = TransformSequence{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransformSequence) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransformSequence) ProtoMessage() {}

func (x *TransformSequence) ProtoReflect() protoreflect.Message {
	mi := &file_generation_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransformSequence.ProtoReflect.Descriptor instead.
func (*TransformSequence) Descriptor() ([]byte, []int) {
	return file_generation_proto_rawDescGZIP(), []int{30}
}

func (x *TransformSequence) GetOperations() []*TransformOperation {
	if x != nil {
		return x.Operations
	}
	return nil
...
type Request struct {
	...
	WeightMethod *WeightMethod          `protobuf:"varint,9,opt,name=weight_method,json=weightMethod,proto3,enum=gooseai.WeightMethod,oneof" json:"weight_method,omitempty"`
	UcPrompt     []*Prompt              `protobuf:"bytes,10,rep,name=uc_prompt,json=ucPrompt,proto3" json:"uc_prompt,omitempty"`
}
...
func (x *Request) GetWeightMethod() WeightMethod {
...
func (x *Request) GetUcPrompt() []*Prompt {
	if x != nil {
		return x.UcPrompt
	}
	return nil
...
var file_generation_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x07, 0x64, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x12, 0x29, 0x0a, 0x10, 0x73, 0x65, 0x6d, 0x61, 0x6e, 0x74, 0x69, 0x63, 0x5f,
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x72, 0x12, 0x38, 0x0a, 0x08, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e,
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x53, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63,
	0x65, 0x48, 0x00, 0x52, 0x08, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x06, 0x0a,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xa0, 0x03, 0x0a, 0x0f, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x50,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x03, 0x75, 0x73,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61,
	0x69, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x55, 0x73, 0x65, 0x52, 0x03, 0x75, 0x73, 0x65, 0x22,
	0xb4, 0x01, 0x0a, 0x0a, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x1a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_generation_proto_enumTypes = make([]protoimpl.EnumInfo, 16)
...
var file_generation_proto_goTypes = []interface{}{
	...
	(AssetAction)(0),                   // 13: gooseai.AssetAction
	(AssetUse)(0),                      // 14: gooseai.AssetUse
	(StageAction)(0),                   // 15: gooseai.StageAction
	(*Token)(nil),                      // 16: gooseai.Token
	(*Tokens)(nil),                     // 17: gooseai.Tokens
	(*Artifact)(nil),                   // 18: gooseai.Artifact
	(*PromptParameters)(nil),           // 19: gooseai.PromptParameters
	(*Prompt)(nil),                     // 20: gooseai.Prompt
	(*SamplerParameters)(nil),          // 21: gooseai.SamplerParameters
	(*ConditionerParameters)(nil),      // 22: gooseai.ConditionerParameters
	(*ScheduleParameters)(nil),         // 23: gooseai.ScheduleParameters
	(*StepParameter)(nil),              // 24: gooseai.StepParameter
	(*Model)(nil),                      // 25: gooseai.Model
	(*CutoutParameters)(nil),           // 26: gooseai.CutoutParameters
	(*GuidanceScheduleParameters)(nil), // 27: gooseai.GuidanceScheduleParameters
	(*GuidanceInstanceParameters)(nil), // 28: gooseai.GuidanceInstanceParameters
	(*GuidanceParameters)(nil),         // 29: gooseai.GuidanceParameters
	(*TransformType)(nil),              // 30: gooseai.TransformType
	(*ImageParameters)(nil),            // 31: gooseai.ImageParameters
	(*ClassifierConcept)(nil),          // 32: gooseai.ClassifierConcept
	(*ClassifierCategory)(nil),         // 33: gooseai.ClassifierCategory
	(*ClassifierParameters)(nil),       // 34: gooseai.ClassifierParameters
	(*InterpolateParameters)(nil),      // 35: gooseai.InterpolateParameters
	(*TransformAddNoise)(nil),          // 36: gooseai.TransformAddNoise
	(*TransformBlend)(nil),             // 37: gooseai.TransformBlend
	(*TransformColorMatch)(nil),        // 38: gooseai.TransformColorMatch
	(*TransformContrast)(nil),          // 39: gooseai.TransformContrast
	(*TransformDepthCalc)(nil),         // 40: gooseai.TransformDepthCalc
	(*TransformMatrix)(nil),            // 41: gooseai.TransformMatrix
	(*TransformWarp2D)(nil),            // 42: gooseai.TransformWarp2d
	(*TransformWarp3D)(nil),            // 43: gooseai.TransformWarp3d
	(*TransformWarpFlow)(nil),          // 44: gooseai.TransformWarpFlow
	(*TransformOperation)(nil),         // 45: gooseai.TransformOperation
	(*TransformSequence)(nil),          // 46: gooseai.TransformSequence
	(*AssetParameters)(nil),            // 47: gooseai.AssetParameters
	(*AnswerMeta)(nil),                 // 48: gooseai.AnswerMeta
	(*Answer)(nil),                     // 49: gooseai.Answer
	(*Request)(nil),                    // 50: gooseai.Request
	(*OnStatus)(nil),                   // 51: gooseai.OnStatus
	(*Stage)(nil),                      // 52: gooseai.Stage
	(*ChainRequest)(nil),               // 53: gooseai.ChainRequest
	(*tensors.Tensor)(nil),             // 54: tensors.Tensor
}
var file_generation_proto_depIdxs = []int32{
	16, // 0: gooseai.Tokens.tokens:type_name -> gooseai.Token
	1,  // 1: gooseai.Artifact.type:type_name -> gooseai.ArtifactType
	17, // 2: gooseai.Artifact.tokens:type_name -> gooseai.Tokens
	34, // 3: gooseai.Artifact.classifier:type_name -> gooseai.ClassifierParameters
	54, // 4: gooseai.Artifact.tensor:type_name -> tensors.Tensor
	0,  // 5: gooseai.Artifact.finish_reason:type_name -> gooseai.FinishReason
	19, // 6: gooseai.Prompt.parameters:type_name -> gooseai.PromptParameters
	17, // 7: gooseai.Prompt.tokens:type_name -> gooseai.Tokens
	18, // 8: gooseai.Prompt.artifact:type_name -> gooseai.Artifact
	25, // 9: gooseai.ConditionerParameters.conditioner:type_name -> gooseai.Model
	21, // 10: gooseai.StepParameter.sampler:type_name -> gooseai.SamplerParameters
	23, // 11: gooseai.StepParameter.schedule:type_name -> gooseai.ScheduleParameters
	29, // 12: gooseai.StepParameter.guidance:type_name -> gooseai.GuidanceParameters
	7,  // 13: gooseai.Model.architecture:type_name -> gooseai.ModelArchitecture
	26, // 14: gooseai.CutoutParameters.cutouts:type_name -> gooseai.CutoutParameters
	25, // 15: gooseai.GuidanceInstanceParameters.models:type_name -> gooseai.Model
	27, // 16: gooseai.GuidanceInstanceParameters.schedule:type_name -> gooseai.GuidanceScheduleParameters
	26, // 17: gooseai.GuidanceInstanceParameters.cutouts:type_name -> gooseai.CutoutParameters
	20, // 18: gooseai.GuidanceInstanceParameters.prompt:type_name -> gooseai.Prompt
	6,  // 19: gooseai.GuidanceParameters.guidance_preset:type_name -> gooseai.GuidancePreset
	28, // 20: gooseai.GuidanceParameters.instances:type_name -> gooseai.GuidanceInstanceParameters
	...
	46, // 23: gooseai.TransformType.sequence:type_name -> gooseai.TransformSequence
	30, // 24: gooseai.ImageParameters.transform:type_name -> gooseai.TransformType
	24, // 25: gooseai.ImageParameters.parameters:type_name -> gooseai.StepParameter
	2,  // 26: gooseai.ImageParameters.masked_area_init:type_name -> gooseai.MaskedAreaInit
	32, // 27: gooseai.ClassifierCategory.concepts:type_name -> gooseai.ClassifierConcept
	...
	33, // 30: gooseai.ClassifierParameters.categories:type_name -> gooseai.ClassifierCategory
	33, // 31: gooseai.ClassifierParameters.exceeds:type_name -> gooseai.ClassifierCategory
	...
	18, // 34: gooseai.TransformBlend.target:type_name -> gooseai.Artifact
	12, // 35: gooseai.TransformColorMatch.color_mode:type_name -> gooseai.ColorMatchMode
	18, // 36: gooseai.TransformColorMatch.image:type_name -> gooseai.Artifact
	11, // 37: gooseai.TransformWarp2d.border_mode:type_name -> gooseai.BorderMode
	41, // 38: gooseai.TransformWarp2d.matrix:type_name -> gooseai.TransformMatrix
	11, // 39: gooseai.TransformWarp3d.border_mode:type_name -> gooseai.BorderMode
	18, // 40: gooseai.TransformWarpFlow.flow_map:type_name -> gooseai.Artifact
	18, // 41: gooseai.TransformWarpFlow.prev_frame:type_name -> gooseai.Artifact
	18, // 42: gooseai.TransformWarpFlow.next_frame:type_name -> gooseai.Artifact
	36, // 43: gooseai.TransformOperation.add_noise:type_name -> gooseai.TransformAddNoise
	37, // 44: gooseai.TransformOperation.blend:type_name -> gooseai.TransformBlend
	38, // 45: gooseai.TransformOperation.color_match:type_name -> gooseai.TransformColorMatch
	39, // 46: gooseai.TransformOperation.contrast:type_name -> gooseai.TransformContrast
	40, // 47: gooseai.TransformOperation.depth_calc:type_name -> gooseai.TransformDepthCalc
	42, // 48: gooseai.TransformOperation.warp2d:type_name -> gooseai.TransformWarp2d
	43, // 49: gooseai.TransformOperation.warp3d:type_name -> gooseai.TransformWarp3d
	44, // 50: gooseai.TransformOperation.warp_flow:type_name -> gooseai.TransformWarpFlow
	45, // 51: gooseai.TransformSequence.operations:type_name -> gooseai.TransformOperation
	13, // 52: gooseai.AssetParameters.action:type_name -> gooseai.AssetAction
	14, // 53: gooseai.AssetParameters.use:type_name -> gooseai.AssetUse
	48, // 54: gooseai.Answer.meta:type_name -> gooseai.AnswerMeta
	18, // 55: gooseai.Answer.artifacts:type_name -> gooseai.Artifact
	1,  // 56: gooseai.Request.requested_type:type_name -> gooseai.ArtifactType
	20, // 57: gooseai.Request.prompt:type_name -> gooseai.Prompt
	31, // 58: gooseai.Request.image:type_name -> gooseai.ImageParameters
	34, // 59: gooseai.Request.classifier:type_name -> gooseai.ClassifierParameters
	47, // 60: gooseai.Request.asset:type_name -> gooseai.AssetParameters
	35, // 61: gooseai.Request.interpolate:type_name -> gooseai.InterpolateParameters
	22, // 62: gooseai.Request.conditioner:type_name -> gooseai.ConditionerParameters
	3,  // 63: gooseai.Request.weight_method:type_name -> gooseai.WeightMethod
	20, // 64: gooseai.Request.uc_prompt:type_name -> gooseai.Prompt
	0,  // 65: gooseai.OnStatus.reason:type_name -> gooseai.FinishReason
	15, // 66: gooseai.OnStatus.action:type_name -> gooseai.StageAction
	50, // 67: gooseai.Stage.request:type_name -> gooseai.Request
	51, // 68: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	52, // 69: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	50, // 70: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	53, // 71: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	49, // 72: gooseai.GenerationService.Generate:output_type -> gooseai.Answer
	49, // 73: gooseai.GenerationService.ChainGenerate:output_type -> gooseai.Answer
...
func file_generation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_generation_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformAddNoise); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_generation_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformContrast); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_generation_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformOperation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_generation_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransformSequence); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_generation_proto_msgTypes[29].OneofWrappers = []interface{}{
		(*TransformOperation_AddNoise)(nil),
		(*TransformOperation_Blend)(nil),
		(*TransformOperation_ColorMatch)(nil),
		(*TransformOperation_Contrast)(nil),
		(*TransformOperation_DepthCalc)(nil),
		(*TransformOperation_Warp2D)(nil),
		(*TransformOperation_Warp3D)(nil),
		(*TransformOperation_WarpFlow)(nil),
	}
